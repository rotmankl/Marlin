...
#define STRING_URL "RotBot"
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(RotBot Bowden)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "RotBot"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.58,78.82,4000,540}
#define DEFAULT_MAX_FEEDRATE          {200, 200, 2, 40}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2000,2000,50,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
