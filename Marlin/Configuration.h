...
#define STRING_CONFIG_H_AUTHOR "(RotBot Direct)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "RotBot Direct"
...
#ifdef PIDTEMPBED
//phebe from autotune
    #define  DEFAULT_bedKp 361
    #define  DEFAULT_bedKi 70
    #define  DEFAULT_bedKd 465
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.82,78.82,4000,540}  // RotBot Direct
#define DEFAULT_MAX_FEEDRATE          {200, 200, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1800,1800,50,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
